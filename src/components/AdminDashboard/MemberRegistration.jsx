...
const MemberRegistration = () => {
  ...
  useEffect(() => {
    const fetchCenters = async () => {
      try {
        const response = await axios.get("https://loanappbackend-dcsb.onrender.com/api/center");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("https://loanappbackend-dcsb.onrender.com/api/member", dataToSubmit);
